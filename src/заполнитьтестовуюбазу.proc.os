...
Процедура Выполнить()
  ...
  Если Создавать Тогда
    ...
    Стр = Сч1.Товары.Добавить(); Стр.Номенклатура = НомТабурет; Стр.Количество = 10; Стр.Цена = 900;  Стр.Сумма = 9000;
    Стр = Сч1.Товары.Добавить(); Стр.Номенклатура = НомСтол;    Стр.Количество = 3;  Стр.Цена = 4500; Стр.Сумма = 13500;
    Сч1.Сумма = 22500;
    Сч1.Записать();
    ...
    Стр = Сч2.Товары.Добавить(); Стр.Номенклатура = НомДиван; Стр.Количество = 2;  Стр.Цена = 14000; Стр.Сумма = 28000;
    Стр = Сч2.Товары.Добавить(); Стр.Номенклатура = НомПолка; Стр.Количество = 12; Стр.Цена = 800;   Стр.Сумма = 9600;
    Сч2.Сумма = 37600;
    Сч2.Записать();
    ...
    Стр = Сч3.Товары.Добавить(); Стр.Номенклатура = НомКровать;  Стр.Количество = 2; Стр.Цена = 35000; Стр.Сумма = 70000;
    Стр = Сч3.Товары.Добавить(); Стр.Номенклатура = НомТумбочка; Стр.Количество = 4; Стр.Цена = 2800;  Стр.Сумма = 11200;
    Стр = Сч3.Товары.Добавить(); Стр.Номенклатура = НомШкаф;     Стр.Количество = 1; Стр.Цена = 22000; Стр.Сумма = 22000;
    Сч3.Сумма = 103200;
    Сч3.Записать();
    ...
    Стр = Сч4.Товары.Добавить(); Стр.Номенклатура = НомКомод;    Стр.Количество = 3; Стр.Цена = 7000;  Стр.Сумма = 21000;
    Стр = Сч4.Товары.Добавить(); Стр.Номенклатура = НомШкаф;     Стр.Количество = 2; Стр.Цена = 22000; Стр.Сумма = 44000;
    Стр = Сч4.Товары.Добавить(); Стр.Номенклатура = НомСтеллаж;  Стр.Количество = 1; Стр.Цена = 6500;  Стр.Сумма = 6500;
    Сч4.Сумма = 71500;
    Сч4.Записать();
