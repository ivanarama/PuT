...
Процедура Выполнить()
  ...
  Если Создавать Тогда
    ...
    ДатаПродаж1  = ДобавитьМесяц(Сегодня, -2);  // первый блок продаж (после сборки/перемещений)
    ДатаПродаж2  = ДобавитьМесяц(Сегодня, -1);  // второй блок продаж
    ДатаПродаж3  = Сегодня;                     // третий блок продаж, счета, заказы
    ...
    Сч1.Номер = "СЧ-00001";
    Сч1.Дата = ДатаПродаж3; Сч1.Организация = НашаОрг; Сч1.Покупатель = ПокупательКафе;
    Сч1.Склад = СкладГлавный; Сч1.ТипЦенПродажи = ТипРозн; Сч1.СпособУчетаНДС = "ВТомЧисле";
    Сч1.СрокОплаты = ДобавитьМесяц(ДатаПродаж3, 1);
    ...
    Сч2.Номер = "СЧ-00002";
    Сч2.Дата = ДатаПродаж3; Сч2.Организация = НашаОрг; Сч2.Покупатель = ПокупательСядь;
    Сч2.Склад = СкладГлавный; Сч2.ТипЦенПродажи = ТипРозн; Сч2.СпособУчетаНДС = "ВТомЧисле";
    Сч2.СрокОплаты = ДобавитьМесяц(ДатаПродаж3, 1);
    ...
    Сч3.Номер = "СЧ-00003";
    Сч3.Дата = ДатаПродаж3; Сч3.Организация = НашаОрг; Сч3.Покупатель = ПокупательГостиница;
    Сч3.Склад = СкладГлавный; Сч3.ТипЦенПродажи = ТипРозн; Сч3.СпособУчетаНДС = "ВТомЧисле";
    Сч3.СрокОплаты = ДобавитьМесяц(ДатаПродаж3, 1);
    ...
    Сч4.Номер = "СЧ-00004";
    Сч4.Дата = ДатаПродаж3; Сч4.Организация = НашаОрг; Сч4.Покупатель = ПокупательРемонт;
    Сч4.Склад = СкладГлавный; Сч4.ТипЦенПродажи = ТипРозн; Сч4.СпособУчетаНДС = "ВТомЧисле";
    Сч4.СрокОплаты = ДобавитьМесяц(ДатаПродаж3, 1);
    ...
    ЗакПок1.Дата = ДатаПродаж3; ЗакПок1.Организация = НашаОрг; ЗакПок1.Покупатель = ПокупательКафе;
    ...
    ЗакПок2.Дата = ДатаПродаж3; ЗакПок2.Организация = НашаОрг; ЗакПок2.Покупатель = ПокупательГостиница;
    ...
    Реал1.Дата = ДатаПродаж1; Реал1.Организация = НашаОрг; Реал1.Покупатель = ПокупательКафе;
    ...
    Реал2.Дата = ДатаПродаж1; Реал2.Организация = НашаОрг; Реал2.Покупатель = ПокупательСядь;
    ...
    Стр = Реал2.Товары.Добавить(); Стр.Номенклатура = НомПолка; Стр.Количество = 12; Стр.Цена = 800;
    ...
    Реал3.Дата = ДатаПродаж2; Реал3.Организация = НашаОрг; Реал3.Покупатель = ПокупательРесторан;
    Реал3.Склад = СкладГлавный; Реал3.ТипЦенПродажи = ТипРозн; Реал3.СпособУчетаНДС = "ВТомЧисле";
    Стр = Реал3.Товары.Добавить(); Стр.Номенклатура = НомКресло;   Стр.Количество = 5; Стр.Цена = 7000;
    ...
    Реал4.Дата = ДатаПродаж2; Реал4.Организация = НашаОрг; Реал4.Покупатель = ПокупательДетсад;
    ...
    Реал5.Дата = ДатаПродаж3; Реал5.Организация = НашаОрг; Реал5.Покупатель = ПокупательГостиница;
    Реал5.Склад = СкладГлавный; Реал5.ТипЦенПродажи = ТипРозн; Реал5.СпособУчетаНДС = "ВТомЧисле";
    Стр = Реал5.Товары.Добавить(); Стр.Номенклатура = НомКровать;  Стр.Количество = 2; Стр.Цена = 35000;
    ...
    Реал6.Дата = ДатаПродаж3; Реал6.Организация = НашаОрг; Реал6.Покупатель = ПокупательРемонт;
    Реал6.Склад = СкладГлавный; Реал6.ТипЦенПродажи = ТипРозн; Реал6.СпособУчетаНДС = "ВТомЧисле";
    Стр = Реал6.Товары.Добавить(); Стр.Номенклатура = НомКомод;    Стр.Количество = 3; Стр.Цена = 5800;
    ...
    ВозвПок1.Дата = ДатаПродаж3; ВозвПок1.Организация = НашаОрг; ВозвПок1.Покупатель = ПокупательКафе;
    ...
    ВозвПост1.Дата = ДатаПродаж3; ВозвПост1.Организация = НашаОрг; ВозвПост1.Поставщик = ПоставщикДерево;
    ...
    БнкП2.Контрагент = ПокупательГостиница; БнкП2.НазначениеПлатежа = "За кровати, тумбочки и шкаф — сording to invoice"; БнкП2.Сумма = 105200;
    ...
    Спис1.Дата = ДатаПродаж3; Спис1.Организация = НашаОрг; Спис1.Склад = СкладГлавный;
    ...
    Спис2.Дата = ДатаПродаж3; Спис2.Организация = НашаОрг; Спис2.Склад = СкладГлавный;
    ...
    Рзб.Номер = "РЗБ-00001";
    Рзб.Дата = ДатаПродаж3; Рзб.Организация = НашаОрг; Рзб.Склад = СкладГлавный;
